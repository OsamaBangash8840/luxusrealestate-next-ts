...
const onError = async (error: AxiosError): Promise<AxiosError> => await Promise.reject(error)
...
axiosInstance.interceptors.response.use((response: AxiosResponse) => response, onError)
