...
export const AddProperty = (): React.ReactElement => {
    ...
    const [payload, setPayload] = useState<IPropertiesPayload>({
        ...
        description: "",
        price: 0,
        location: { type: "Point", coordinates: [0, 0] }, // Default structure
        type: "",
        buildYear: 0,
        size: "",
        lotSize: "",
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            toast.success(`${response.data.title} added successfully!`);
            setLoading(false);
            router.push("/");
        } catch (err:any) {
            setLoading(false);
    ...
    return (
        <div className="max-w-screen-lg mx-auto p-6 bg-white rounded-lg shadow-md">
            <Typography variant="h1" className=" text-center mb-2 p-2">Add Property Form</Typography>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-2">
              <Typography variant="h5" className="text-black mb-2"> Select Category</Typography>
                   <select
                    name="category"
              ...
              {errors.category && <p className="text-red-500 text-sm">{errors.category}</p>}
                ...
                <div className="mb-3">
                    <Typography variant="h5" className="text-black mb-2">Longitude</Typography>
                    <TextField
                        name="coordinatesLng"
                        type="number"
                ...
                <div className="mb-2">
                    <Typography variant="h5" className="text-black mb-2">Latitude</Typography>
                    <TextField
                        name="coordinatesLat"
                        type="number"
             ...
             <div className="grid sm:grid-cols-2">
                ...
                <div className="mb-2">
                    <Typography variant="h5" className="text-black mb-2">Property Price ($)
                    </Typography>
                    <TextField
                        name="price"
                        type="number"
