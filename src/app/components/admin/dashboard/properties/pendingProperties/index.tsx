...
import { usePendingPropertiesQuery } from '@/app/lib/features/auth/admin/dashboard/propertyStatus/AllProperties/adminPropertiesApiSlice'
import axios from 'axios'
import { useEffect, useState } from 'react'
const API_KEY = '63286d2185d3b4e90728e054b59870df'

export const PendingProperties = (): React.ReactElement => {
  const { data, error, isLoading } = usePendingPropertiesQuery()
