...
import { useRejectedPropertiesQuery } from '@/app/lib/features/auth/admin/dashboard/propertyStatus/AllProperties/adminPropertiesApiSlice'
import axios from 'axios'
import { useEffect, useState } from 'react'
const API_KEY = '63286d2185d3b4e90728e054b59870df'
export const RejectedProperties = (): React.ReactElement => {
  const { data, error, isLoading } = useRejectedPropertiesQuery()
  ...
  return (
    <>
      <div className="grid grid-cols sm:grid-cols-[200px_200px] md:grid-cols-[300px_300px_300px_300px] 2xl:grid-cols-4 2xl:px-48 px-5 sm:px-2 gap-3">
        {data?.map((property) => (
          <PropertyCard
            key={property._id}
            property={property}
